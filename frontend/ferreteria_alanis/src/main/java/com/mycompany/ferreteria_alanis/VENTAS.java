        ...
        new SwingWorker<ProductoDTO, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    // Fila 2: etiquetas Cantidad y Precio
                    gc.gridy = 2; gc.gridwidth = 1; gc.weightx = 1;
                    gc.gridx = 0; body.add(new JLabel("Cantidad:"), gc);
                    gc.gridx = 1; gc.weightx = 0; body.add(new JLabel(""), gc);
                    gc.gridx = 2; gc.weightx = 1; body.add(new JLabel("Precio con impuestos:"), gc);

                    // Fila 3: campo cantidad  X  campo precio
                    gc.gridy = 3;
                    ...
                    BigDecimal precioConIva = precioOriginal
                    ...
                    // Fila 4: checkbox IVA  +  botón Aceptar
                    ...
                    // Recalcular precio al cambiar el checkbox de IVA
                    ...
                    // Aceptar → validar cantidad → agregar renglón al ticket
                    ...
                    // Enter en el campo cantidad también acepta
                    txtCantDlg.addActionListener(ev -> btnAceptarDlg.doClick());
